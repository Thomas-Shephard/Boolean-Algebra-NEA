...
public class Identifier : IEquatable<Identifier> {
    ...
    /// <summary>
    /// Determines whether the lexer and parser will recognise the identifier depending on whether the lexer and parser are using generic operands.
    /// A generic operand is used when a syntax tree is being generated by the simplification rule builder.
    /// </summary>
    ...
    /// <param name="isGenericOperand">Determines whether the lexer and parser will recognise the identifier depending on whether the lexer and parser are using generic operands.</param>
    ...
    public override bool Equals(object? obj) {
        ...
        return Equals(obj as Identifier);               //If the object is not this object, compare its properties with this object's properties.
    }
