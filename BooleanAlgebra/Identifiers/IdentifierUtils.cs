...
/// <summary>
/// Provides a set of methods to work with identifiers.
/// Gets the maximum precedence of the possible identifiers.
/// Determines if a given lexeme value matches any possible identifiers and provides the identifier if so.
/// </summary>
public static class IdentifierUtils {
    ...
    private static Identifier[] GenerateIdentifiers() {
        return new[] {
            ...
            //This is a LEFT PARENTHESIS it matches '('. It has a precedence of 4 and doesn't require any context.
            new Identifier(IdentifierType.GROUPING_OPERATOR_START, 4, "PARENTHESIS", "^\\($", false, false),
            //This is a RIGHT PARENTHESIS it matches ')'. It has a precedence of 4 and doesn't require any context.
            new Identifier(IdentifierType.GROUPING_OPERATOR_END, 4, "PARENTHESIS", "^\\)$", false, false),
            //This is a LEFT SQUARE BRACKET it matches '['. It has a precedence of 4 and doesn't require any context.
            ...
            //This is a RIGHT SQUARE BRACKET it matches ']'. It has a precedence of 4 and doesn't require any context.
            //This identifier can only be used when the lexer is using generic operands (i.e. when a syntax tree is being generated by the simplification rule builder).
